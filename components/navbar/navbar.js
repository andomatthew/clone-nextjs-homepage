            ...
            <nav className={`${customFixedTop50} navbar fixed-top navbar-expand-lg navbar-light bg-light`}>
                <div className="container-fluid">
                    ...
                    <div>
                        ...
                        <button className="navbar-toggler d-md-none" type="button" data-bs-toggle="collapse" data-bs-target="#myNavbar" aria-controls="myNavbar" aria-expanded="false" aria-label="Toggle navigation">
